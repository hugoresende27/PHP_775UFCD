...
//<?php echo é igual a <?= 
    ...
    if(!isset($_COOKIE['contadorVisitas'])){
        ...
        $numVisitas = $_COOKIE['contadorVisitas'] + 1;
...
<body>
    ...
    <h1>aula de cookies PARTE 2</h1>

    <p>Olá bem vindo segunda página <span class="vermelho negrito"> <?= $utilizador  ?> </span> à página inicial </p>
...
<p>
    <a href="cookies.php">Ligar a parte 1</a> |
